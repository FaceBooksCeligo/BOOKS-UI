...
export default function EditItemPage() {
    ...
    try {
      ...
      if (response.success) {
        ...
        setForm({
          ...
          expenseAccount: item.expenseAccountId || "",
          assetAccount: item.assetAccountId || "no-asset",
          notes: item.notes || "",
        });
      } else {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await api.put(`/v1/items/${params.id}`, {
        sku: form.sku,
        name: form.name,
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update the basic details for this inventory item
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update pricing and inventory tracking options
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
